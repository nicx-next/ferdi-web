  ...
  <Layout>
    ...
    <div className={'container'}>
      <div className={'content'}>
        ...
        <p>
          At Ferdi, accessible from https://getferdi.com, one of our main priorities is the privacy of our visitors.
          This Privacy Policy document contains types of information that is collected and recorded by Ferdi and how we
          use it.
        </p>
        <p>
          If you have additional questions or require more information about our Privacy Policy, do not hesitate to
          contact us through email at contact@getferdi.com
        </p>

        <h3>Log Files</h3>
        <p>
          Ferdi follows a standard procedure of using log files. These files log visitors when they visit websites. All
        ...
        <p>
          Like any other website, Ferdi uses 'cookies'. These cookies are used to store information including visitors'
        ...
        <p>
          You may consult this list to find the Privacy Policy for each of the advertising partners of Ferdi. Our
        ...
        <p>
          ...
          in their respective advertisements and links that appear on Ferdi, which are sent directly to users' browser.
        ...
        <p>
          Ferdi's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
        ...
        <p>
          Ferdi does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
        ...
        <p>
          ...
          regards to the information that they shared and/or collect in Ferdi. This policy is not applicable to any
